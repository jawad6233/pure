...
CFLAGS="-mtune=cortex-a53 -march=armv8-a -mcpu=cortex-a53 -O2" ARCH=arm64 CROSS_COMPILE=/home/imzf/tmp/aarch64-linux-android-4.9/bin/aarch64-linux-android- make menuconfig
echo "> Iniciando compilacion del kernel usando .config"
CFLAGS="-mtune=cortex-a53 -march=armv8-a -mcpu=cortex-a53 -O2" ARCH=arm64 CROSS_COMPILE=/home/imzf/tmp/aarch64-linux-android-4.9/bin/aarch64-linux-android- make -j4
echo ""
