...
static struct pll_freq_tbl apcs_c1_pll_freq[] = {
	...
	F_APCS_PLL(1751200000, 90, 0x0, 0x1, 0x0, 0x0, 0x0),
	F_APCS_PLL(1889600000, 100, 0x0, 0x1, 0x0, 0x0, 0x0),
};
...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_clk_8937_475MHz[] = {
	...
	F_SLEW( 515000000, 950000000,	  gpll3,	1,	0,	0),
	F_SLEW( 575000000, 1150000000,	  gpll3,	1,	0,	0),
	F_SLEW( 585000000, 1150000000,	  gpll3,	1,	0,	0),
	F_SLEW( 600000000, 1200000000,    gpll3,        1,      0,      0),
	F_SLEW( 635000000, 1200000000,    gpll3,        1,      0,      0),
	F_END
};
...
static void override_for_8937(int speed_bin)
{
	...
	if (speed_bin) {
		OVERRIDE_FMAX6(gfx3d,
			LOWER, 50000000, LOW, 300000000,
			NOMINAL, 400000000, NOM_PLUS, 450000000,
			HIGH, 515000000, SUPER_TUR, 635000000);
